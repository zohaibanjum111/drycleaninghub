...
?>
  ...
  <!-- Page wrapper  -->
        <div class="page-wrapper; width:100% ">
            <!-- Bread crumb -->
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Sign Up As A Store Management</h3> </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="input-states">
                                    <form class="form-horizontal" method="POST" action="pages/save_onlineuser.php" name="userform" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text"  name="lname" id="lname" class="form-control" id="event" onkeydown="return alphaOnly(event);" placeholder="Shop Name" required="">
                                                </div>
                                            </div>
                                        </div>
