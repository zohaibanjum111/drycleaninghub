            ...
            <div class="row">
                <div class="col-md-6 text-center text-lg-left mb-2 mb-lg-0">
                    <div class="d-inline-flex align-items-center">
                        <a class="text-white pr-3" href="http:\\www.google.com">FAQs</a>
                        <span class="text-white">|</span>
                        <a class="text-white px-3" href="http:\\www.google.com">Help</a>
                        <span class="text-white">|</span>
                        <a class="text-white pl-3" href="http:\\www.google.com">Support</a>
                    </div>
                </div>
                <div class="col-md-6 text-center text-lg-right">
                    <div class="d-inline-flex align-items-center">
                        <a class="text-white px-3" href="http:\\www.facebook.com">
                            <i class="fab fa-facebook-f"></i>
                        </a>
                        <a class="text-white px-3" href="http:\\www.twitter.com">
                            <i class="fab fa-twitter"></i>
                        </a>
                        <a class="text-white px-3" href="#">
                            <i class="fab fa-linkedin-in"></i>
                        </a>
                        <a class="text-white px-3" href="http:\\www.instagram.com">
                            <i class="fab fa-instagram"></i>
                        </a>
                        <a class="text-white pl-3" href="http:\\www.youtube.com">
            ...
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0 pl-3 pl-lg-5">
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <a href="fyp\about.html" class="nav-item nav-link">About</a>
                        <a href="fyp\service.html" class="nav-item nav-link">Services</a>
                        <a href="fyp\pricing.html" class="nav-item nav-link">Pricing</a>
           <!--           <div class="nav-item dropdown">
                    ...
                    <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu border-0 rounded-0 m-0">
                                ...
                                <a href="register.php" class="dropdown-item">Signup</a>
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <h1 class="display-3 text-white mb-md-4">Order Booking</h1>
                            <a href="\drycleaninghub.com\back_end\add_onlineCustomer.php" class="btn btn-primary py-md-3 px-md-5 mt-2">Place Order</a>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-md-3">Laundry & Dry Cleaning</h4>
                            <h1 class="display-3 text-white mb-md-4">Open dry cleaning shop</h1>
                            <a href="\drycleaninghub.com\back_end\login.php" class="btn btn-primary py-md-3 px-md-5 mt-2">Sign Up</a>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-md-3">Laundry & Dry Cleaning</h4>
                            <h1 class="display-3 text-white mb-md-4">Become Delivery Boy</h1>
                            <a href="register.php" class="btn btn-primary py-md-3 px-md-5 mt-2">Sign Up</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-4 d-flex align-items-center justify-content-center bg-secondary mb-4 mb-lg-0" style="height: 100px;">
                    <div class="d-inline-flex">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <p class="m-0 text-white">37 Street, Sector I-9/4, Islamabad, Pakistan</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 d-flex align-items-center justify-content-center bg-primary mb-4 mb-lg-0" style="height: 100px;">
                    <div class="d-inline-flex text-left">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <p class="m-0 text-white">waseem29598@gmail.com</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 d-flex align-items-center justify-content-center bg-secondary mb-4 mb-lg-0" style="height: 100px;">
                    <div class="d-inline-flex text-left">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <p class="m-0 text-white">+092 316 52 66 332</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container pt-0 pt-lg-4">
            <div class="row align-items-center">
                ...
                <div class="col-lg-7 mt-5 mt-lg-0 pl-lg-5">
                    ...
                    <h1 class="mb-4">We Are provinding a unique dry cleaning web plateform</h1>
                    <h5 class="font-weight-medium font-italic mb-4">Where</h5>
                    <p class="mb-2"><b>As Customer</b>: You can place order for dry cleaning services as well as pickup services of garments at your door step.<br> <b>Store Manager</b>: You can open your online dry cleaning Store and make more customers online<br><b>delivery Boy</b>: You Can Start pickup and delivery bussiness</p>
                    <div class="row">
                        ...
                        <div class="col-sm-6 pt-3">
                            <div class="d-flex align-items-center">
                                <i class="fa fa-check text-primary mr-2"></i>
                                <p class="text-secondary font-weight-medium m-0">Open Online dry cleaning Shop</p>
                            </div>
                        </div>
                        <div class="col-sm-6 pt-3">
                            <div class="d-flex align-items-center">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 pb-1">
                    <div class="d-flex flex-column align-items-center justify-content-center text-center bg-light mb-4 px-4" style="height: 300px;">
                        ...
                        <h4 class="font-weight-bold m-0">Dry Cleaning booking</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 pb-1">
                    <div class="d-flex flex-column align-items-center justify-content-center text-center bg-light mb-4 px-4" style="height: 300px;">
                ...
                <div class="col-lg-3 col-md-6 pb-1">
                    <div class="d-flex flex-column align-items-center justify-content-center text-center bg-light mb-4 px-4" style="height: 300px;">
                        ...
                        <h4 class="font-weight-bold m-0">Contact To Laundry Shop Manager</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 pb-1">
                    <div class="d-flex flex-column align-items-center justify-content-center text-center bg-light mb-4 px-4" style="height: 300px;">
                        ...
                        <h4 class="font-weight-bold m-0">Pickup and Delivery of Garments</h4>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7 m-0 my-lg-5 pt-0 pt-lg-5 pr-lg-5">
                    ...
                    <p>We provide all service on very low rates with quick and fast delivery services</p>
                    <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="d-flex flex-column align-items-center justify-content-center text-center mb-5">
                        ...
                        <h3 class="font-weight-bold m-0 mt-2">Put Request for Pick Up</h3>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="d-flex flex-column align-items-center justify-content-center text-center mb-5">
                    ...
                    <div class="bg-light text-center mb-2 pt-4">
                        <div class="d-inline-flex flex-column align-items-center justify-content-center bg-secondary rounded-circle shadow mt-2 mb-4" style="width: 200px; height: 200px; border: 15px solid #ffffff;">
                            ...
                            <h1 class="display-4 text-white mb-0">
                                <small class="align-top" style="font-size: 22px; line-height: 45px;">Rs</small>49<small class="align-bottom" style="font-size: 16px; line-height: 40px;">/ S</small>
                            </h1>
                        </div>
                ...
                <div class="col-lg-4 mb-4">
                    <div class="bg-light text-center mb-2 pt-4">
                        <div class="d-inline-flex flex-column align-items-center justify-content-center bg-primary rounded-circle shadow mt-2 mb-4" style="width: 200px; height: 200px; border: 15px solid #ffffff;">
                            <h3 class="text-white">Dry And Cleaning</h3>
                            <h1 class="display-4 text-white mb-0">
                                <small class="align-top" style="font-size: 22px; line-height: 45px;">Rs</small>120<small class="align-bottom" style="font-size: 16px; line-height: 40px;">/ S</small>
                            </h1>
                        </div>
                        <div class="d-flex flex-column align-items-center py-3">
                            <p>clothes</p>
                        ...
                        <a href="register.php" class="btn btn-primary py-2 px-4">Signup Now</a>
                    </div>
                </div>
                <div class="col-lg-4 mb-4">
                    <div class="bg-light text-center mb-2 pt-4">
                        <div class="d-inline-flex flex-column align-items-center justify-content-center bg-secondary rounded-circle shadow mt-2 mb-4" style="width: 200px; height: 200px; border: 15px solid #ffffff;">
                            <h3 class="text-white">Just Iron</h3>
                            <h1 class="display-4 text-white mb-0">
                                <small class="align-top" style="font-size: 22px; line-height: 45px;">Rs</small>50<small class="align-bottom" style="font-size: 16px; line-height: 40px;">/ S</small>
                            </h1>
                        </div>
                        <div class="d-flex flex-column align-items-center py-3">
                            <p>clothes</p>
                        ...
                        <a href="register.php" class="btn btn-secondary py-2 px-4">Signup Now</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="owl-carousel testimonial-carousel">
                <div class="testimonial-item">
                    ...
                    <div class="bg-light text-center p-4 pt-0">
                        <h5 class="font-weight-medium mt-5">Miss.Fiqa</h5>
                        <p class="text-muted font-italic">Profession</p>
                        <p class="m-0">student of iqra universit</p>
                    </div>
                </div>
                <div class="testimonial-item">
                    <img class="position-relative rounded-circle bg-white shadow mx-auto" src="img/testimonial-3.jpeg" style="width: 100px; height: 100px; padding: 12px; margin-bottom: -50px; z-index: 1;" alt="">
                    <div class="bg-light text-center p-4 pt-0">
                        <h5 class="font-weight-medium mt-5">Mr. Kamran</h5>
                        <p class="text-muted font-italic">Profession</p>
                        <p class="m-0">teacher</p>
                    </div>
                </div>
                <div class="testimonial-item">
                    <img class="position-relative rounded-circle bg-white shadow mx-auto" src="img/testimonial-1.jpeg" style="width: 100px; height: 100px; padding: 12px; margin-bottom: -50px; z-index: 1;" alt="">
                    <div class="bg-light text-center p-4 pt-0">
                        <h5 class="font-weight-medium mt-5">Mr. bilal</h5>
                        <p class="text-muted font-italic">Profession</p>
                ...
                <div class="testimonial-item">
                    <img class="position-relative rounded-circle bg-white shadow mx-auto" src="img/testimonial-4.jpg" style="width: 100px; height: 100px; padding: 12px; margin-bottom: -50px; z-index: 1;" alt="">
                    <div class="bg-light text-center p-4 pt-0">
                        <h5 class="font-weight-medium mt-5">Miss. Maria</h5>
                        <p class="text-muted font-italic">Profession</p>
                        <p class="m-0">Actor</p>
                    </div>
                </div>
 ...
 <!-- Blog Start -->
    ...
    <div class="container-fluid bg-primary text-white mt-5 pt-5 px-sm-3 px-md-5">
        <div class="row pt-5">
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <p>office in Islamabad</p>
                <p><i class="fa fa-map-marker-alt mr-2"></i>37 Street, Sector i-9/4, Islamabad, Pakistan</p>
                <p><i class="fa fa-phone-alt mr-2"></i>+012 316 52 66 332</p>
                <p><i class="fa fa-envelope mr-2"></i>iuic@gmail.com</p>
            </div>
            <div class="col-lg-3 col-md-6 mb-5">
    ...
    <div class="container-fluid bg-dark text-white py-4 px-sm-3 px-md-5">
        <p class="m-0 text-center text-white">
            &copy; <a class="text-white font-weight-medium" href="#">Pak Dry cleaning and Delivery Service</a>. All Rights Reserved. Designed by Iqrian Student
